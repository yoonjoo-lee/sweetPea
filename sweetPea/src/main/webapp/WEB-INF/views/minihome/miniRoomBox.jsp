...
<img class="draggable" id="item${item.uiidx}" alt="${item.uiidx }" style="height:100px; left:${item.mleft}px; top:${item.mtop}px; " src='<%=request.getContextPath()%>/item/imageView.do?originFileName=${item.img }'/>
